...
xmlns:pra="http://www.saga.it/egov/esicra/esportazione/xml/esicra_pra">
   ...
   <xsl:template name="PraIscrizioneCentro" match="/">
         <xsl:apply-templates select="//pra:PraIscrizioneCentro" />
   </xsl:template>

<xsl:template  match="//pra:PraIscrizioneCentro">
	
<xsl:element name="PraIscrizioneCentro">
