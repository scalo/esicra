...
xmlns:pra="http://www.saga.it/egov/esicra/esportazione/xml/esicra_pra">
  ...
  <xsl:template name="EsercizioAmp">

  <xsl:for-each select="//pra:DatiDenunciaDAC/pra:Comunicazione/pra:DatiAmpliamento/pra:Esercizio">
...
<!--IndirizzoEsercizio-->
        <xsl:for-each select="//pra:DatiAmpliamento/pra:Esercizio/pra:DatiEsercizio/pra:Indirizzo">
