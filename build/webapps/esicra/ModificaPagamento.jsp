...
<c:import url="barramenu.jsp">
      <c:param name="menu"
               value="|Gestione Pratica ,PraticaEdit.jsp?pkid=${param.testa_pkid}|ListaPratiche,RicercaPratiche.jsp, myimg/cartella.jpg|"/>
    </c:import>
    <br/>
    <c:import url="header.jsp">
      ...
      <c:param name="titolo_contenuto"
               value="Pagamento:${param.pag_pkid}"/>
    </c:import>
    <br/>
...
<hib:load var="pagamento" classname="it.saga.siscotel.db.PraPraticaPag" value="${param.pag_pkid}" />

<c:choose>
  <c:when test='${param.modifica eq "modifica"}' >
    ...
    <!--
      unica cosa da fare a causa dei BigDecimal
    -->
    <%
    ...
    <fmt:parseDate var="dtScadenza" pattern="dd/MM/yyyy" value="${param.dtDistinta}" />
    <!-- bigdecimal-->
...
<form name="GestionePagamenti" action="ModificaPagamento.jsp"  method="post" onsubmit="return verificaCampi()">
...
<input type="hidden" name="pag_pkid" value='<c:out value="${param.pag_pkid}" />'/>
                    ...
                    <td>
                        <table class = "LabelForm"> 
                           <tr><td colspan="5" align="center"><b>Bolletta di Riferimento</b></td></tr>
                            ...
                            <tr>
                                <td>Anno:</td>
                                <td><input type="text" name="anno" value='<c:out value= "${pagamento.anno}" />'  class = "campi"></td>
                                <td>Num. Rata:</td>
                                <td><input type="text" name="numRata" value='<c:out value="${pagamento.numRata}" />' class = "campi"></td>
                            </tr>
                            <tr>
                                <td>Causale</td>
                                <td colspan = 3><input type="text" name="causale" value='<c:out value="${pagamento.causale}" />'  class = "campi"></td>
                            </tr>
                            <tr>
                                <td>Importo Rata:</td>
                                <td><input type="text" name="importoDaPagare"  value='<c:out value="${pagamento.importoDaPagare}" />' onblur="validaMoney(this);" class = "campi" ></td>
                                <td>Totale:</td>
                                <td><input type="text" name="importoTotale"  value='<c:out value="${pagamento.importoTotale}" />' onblur="validaMoney(this);"  class = "campi"></td>
                            </tr>
                            <tr>
                                <td>Data Scadenza:</td>
                                <td>
                                <input type="text" name="dtScadenza" id="dtScadenza"
                                           value='<fmt:formatDate value="${pagamento.dtScadenza}" pattern="dd/MM/yyyy" />' onblur="validaData(this)"
                    ...
                    <td>
                        <table class = "LabelForm">                           
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="importoPagato" value='<c:out value="${pagamento.importoPagato}" />' onblur="validaMoney(this);"  class = "campi"></td>
                                <td>Data Pagamento:</td>
                                <td>
                                  <input type="text" name="dtPagamento" id="dtPagamento"
                                           value='<fmt:formatDate value="${pagamento.dtPagamento}" pattern="dd/MM/yyyy" />' onblur="validaData(this)"
                                           size="18" class="campi"></input>
                            ...
                            <tr>
                                ...
                                <td><input type="text" size="30" name="distinta"  value='<c:out value="${pagamento.distinta}" />' class = "campi"></td>
                                <td>Data Distinta:</td>
                                <td>
                                    <input type="text" name="dtDistinta" id="dtDistinta"
                                           value='<fmt:formatDate value="${pagamento.dtDistinta}" pattern="dd/MM/yyyy" />' onblur="validaData(this)"
                                           size="18" class="campi"></input>
                            ...
                            <tr>
                                ...
                                <td>
                                  <input type="text" name="dtRegistrazione" id="dtRegistrazione"
                                           value='<fmt:formatDate value="${pagamento.dtRegistrazione}" pattern="dd/MM/yyyy" />' onblur="validaData(this)"
                                           size="18" class="campi"></input>
                            ...
                            <tr>
                                <td>Cod. Tipo:</td>
                                <td><input type="text" name="codTipoPagamento" value='<c:out value="${pagamento.codTipoPagamento}" />' class = "campi"></td>
                                <td>Des. Tipo:</td>
                                <td><input type="text" name="desTipoPagamento" value='<c:out value="${pagamento.desTipoPagamento}" />' class = "campi"></td>
                            </tr>
                       </table>
                    </td>
                </tr>
...
<p align="center">
<input type="submit" name="modifica" value="modifica" onclick="" class="pulsante">
</p>
